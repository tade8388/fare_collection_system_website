...
module.exports =  (user_Type , passport)=>{
       ...
       passport.use(new Strategy( options,async (payload,done)=>{
         ...
         //  console.log(user_Type)
           ...
           var employee = await Employee_credential.search_For_Employee_Credential_IV({_id: payload.data._id}) //,(err, employee)=>{
          ...
          var customer = await Customer.search_For_Wallet_IV({_id: payload.data._id})  //, ()=>{
            //  if(err)  return done(err,false);
