  ...
  _createClass(OrsPois, [{
    ...
    value: function poisPromise() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        url += _constants2.default.propNames.apiKey + '=' + that.args[_constants2.default.propNames.apiKey];
        ...
        _superagent2.default.post(url).send(payload).set('Authorization', authorization)
