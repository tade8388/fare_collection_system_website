  ...
  _createClass(OrsElevation, [{
    ...
    value: function elevationPromise() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        ...
        _superagent2.default.post(url).send(payload).accept(that.args[_constants2.default.propNames.mimeType]).set('Authorization', authorization).timeout(timeout).end(function (err, res) {
