  ...
  <v-app>
    <v-content class="grey lighten-3">
      ...
      <v-card elevation="0" class="ma-4" min-width="400">
        ...
        <div v-for="(branch, index) in EmployeeInformation" :key="index">
          <v-card-subtitle>name:{{ branch.station_Name }}</v-card-subtitle>
          <v-card-text>station type:{{ branch.station_Type }}</v-card-text>
          <v-card-text>station id:{{ branch.station_Id }}</v-card-text>
...
<script>
import CustomerService from "./../../service/StationService";
